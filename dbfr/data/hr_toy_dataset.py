...
class HQDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        with open('/home/tangb_lab/cse12132338/AttributeEncode/GFPGAN_modified/name2age.txt','rb') as f:
            self.ages = pickle.load(f)
        with open('/home/tangb_lab/cse12132338/AttributeEncode/GFPGAN_modified/name2gender.txt','rb') as f:
    ...
    def __getitem__(self, index):
        ...
        if self.crop_components:
            ...
            return {'lq': img_gt, 'gt': img_gt, 'gt_path': gt_path,'age': age_vector,'age_gt':torch.tensor(age_gt),'gender_gt':torch.tensor(gender_gt)}
